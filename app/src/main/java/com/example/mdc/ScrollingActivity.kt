...
class ScrollingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bottomAppBar = findViewById<BottomAppBar>(R.id.botton_app_bar)
        ...
        val bottomAppBar = binding.bottonAppBar
        ...
        binding.content.toggleButton.addOnButtonCheckedListener { _, checkedId, isChecked ->
            if(isChecked)
            {
    ...
    private fun cargarUrl(url: String = "https://www.computerworld.es/archivos/201909/code.jpg")
    {
        Glide.with(this)
            .load(url)
